...
pose_initialization_model = 3d_pose_tracking.PoseInitializationModel(
...
keypoint_model = 3d_pose_tracking.KeypointModel(
...
pose_tracking_model = 3d_pose_tracking.PoseTrackingModel(
    cost_threshold = 1.0,
...
initial_poses_2d = 3d_pose_tracking.Poses2D.from_dataframe_row(
    dataframe_row = initial_dataframe_row,
    camera_names = camera_names)

initial_poses_3d = 3d_pose_tracking.Poses3D.from_poses_2d(
    poses_2d = initial_poses_2d,
    cameras = camera_calibration_parameters)

pose_tracks = 3d_pose_tracking.Pose3DTracks.initialize(
...
for row_index in range(1, num_rows):
    ...
    poses_2d = 3d_pose_tracking.Poses2D.from_dataframe_row(
        dataframe_row,
        camera_names)
    poses_3d = 3d_pose_tracking.Poses3D.from_poses_2d(
        poses_2d,
